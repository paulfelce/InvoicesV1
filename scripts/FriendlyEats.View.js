...
FriendlyEats.prototype.viewList = function(filters, filter_description) {
  ...
  var renderer = {
    ...
    display: function(doc) {
      var data = doc.data();
      data['.id'] = doc.id;
      data['go_to_invoice'] = function() {
        that.router.navigate('/invoices/' + doc.id);
      };
      ...
      button.addEventListener('click', function(event) {                
        ...
        //that.addMockRestaurants();      
         that.addInvoice({ 
             ...
             invoiceclientaddress1:data.invoiceclientaddress1,
...
FriendlyEats.prototype.viewInvoice = function(id) {
  var sectionHeaderEl;
  ...
  return this.getInvoice(id)
    ...
    //       console.log('getting ratings PF Apr5 1943');
